...
class UpdateActiveCategoryUseCase
{
    ...
    public function __invoke(UpdateActiveCategoryCommand $command): Category
    {
        $this->validateOrFail(
            $command->getId(),
        ...
        try {
            $category = $this->categoryRepository->updateActive($command);
