...
class UpdateActiveLocationUseCase
{
    ...
    public function __invoke(UpdateActiveLocationCommand $command): Location
    {
        $this->validateOrFail(
            $command->getId(),
        ...
        try {
            $location = $this->locationRepository->updateActive($command);
