...
use App\Application\Table\Handlers\UpdateTableCommandHandler;
...
class PutTableController
{
    use ApiResponseTrait;

    public function __construct(
        private readonly UpdateTableUseCase $updateTableUseCase,
        private readonly UpdateTableCommandHandler $updateTableCommandHandler
    ) {}
    ...
    public function __invoke(Request $request): JsonResponse
    {
        try {
            ...
            $result = $this->updateTableCommandHandler->handle($command);
