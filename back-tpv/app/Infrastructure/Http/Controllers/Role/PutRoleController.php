...
use App\Application\Role\Handlers\UpdateRoleCommandHandler;
...
class PutRoleController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        try {
            ...
            $result = $this->updateRoleCommandHandler->handle($command);
            ...
            Log::channel('employee')->warning(
                "La validación fallóal actualizar el rol {$request->input('id')}\n" .
                "   Clase: " . __CLASS__ . "\n" .
            ...
            Log::channel('employee')->warning(
                "Error en algún campo al actualizar el rol {$request->input('id')}\n" .
                "   Clase: " . __CLASS__ . "\n" .
                "   Mensaje: " . $e->getMessage() . "\n" .
                "   Línea: " . $e->getLine() . "\n" .
                "   Trace:\n" . collect($e->getTrace())
            ...
            Log::channel('employee')->error(
                "Error al actualizar el rol {$request->input('id')}\n" .
                "   Clase: " . __CLASS__ . "\n" .
                "   Mensaje: " . $e->getMessage() . "\n" .
                "   Línea: " . $e->getLine() . "\n" .
                "   Trace:\n" . collect($e->getTrace())
