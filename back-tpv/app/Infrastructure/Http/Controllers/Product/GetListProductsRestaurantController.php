...
class GetListProductsRestaurantController
{
    use ApiResponseTrait;

    public function __construct(
        private readonly ListProductsRestaurantUseCase $listProductsRestaurantUseCase,
        private readonly ListProductsRestaurantCommandHandler $listProductsRestaurantCommandHandler,
    ) {
    ...
    public function __invoke(Request $request)
    {
        ...
        try {
            ...
            Log::channel('product')->error(
                "Error al listar los productos del restaurante {$request->input('id_restaurante')}\n" .
                "   Clase: " . __CLASS__ . "\n" .
