...
class DeletePaymentController
{
    ...
    public function __construct(
        ...
        private readonly DeletePaymentCommandHandler $deletePaymentUseCommandHandler,
    ) {
    ...
    {
        $id = new DeletePaymentCommand(
            (int) $request->input("id"),
        );

        try {
            $this->isNanId($id->getId());
            $result = $this->deletePaymentUseCommandHandler->handle($id);
            if (!$result) {
            ...
            Log::channel('order')->warning(
                "La validación fallóal borrar el pago {$request->input('id')}\n" .
                "   Clase: " . __CLASS__ . "\n" .
            ...
            Log::channel('order')->warning(
                "Error en algún campo al borrar el pago {$request->input('id')}\n" .
                "   Clase: " . __CLASS__ . "\n" .
                "   Mensaje: " . $e->getMessage() . "\n" .
                "   Línea: " . $e->getLine() . "\n" .
                "   Trace:\n" . collect($e->getTrace())
            ...
            Log::channel('order')->error(
                "Error al borrar el pago {$request->input('id')}\n" .
                "   Clase: " . __CLASS__ . "\n" .
                "   Mensaje: " . $e->getMessage() . "\n" .
                "   Línea: " . $e->getLine() . "\n" .
                "   Trace:\n" . collect($e->getTrace())
